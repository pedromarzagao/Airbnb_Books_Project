...
user1 = User.create!(email:"andreiadomingues@gmail.com", password:"123456", name:"Andreia Domingues", remote_picture_url: "http://res.cloudinary.com/pmarzagao/image/upload/v1527683260/8GaEWuxK_400x400.jpg")
user2 = User.create!(email:"jeromedharveng@gmail.com", password:"123456", name: "Jerome Harveng", remote_picture_url:"http://res.cloudinary.com/pmarzagao/image/upload/v1527684917/image_2.png")
user3 = User.create!(email:"pedromarzagao@gmail.com", password:"123456", name: "Pedro Marzagão", remote_picture_url: "http://res.cloudinary.com/pmarzagao/image/upload/v1527683243/Pedro_Headshot_2.jpg")
user4 = User.create!(email:"alexandrefontes@gmail.com", password:"123456", name: "Alexandre Fontes", remote_picture_url: "http://res.cloudinary.com/pmarzagao/image/upload/v1527683260/8GaEWuxK_400x400.jpg")
